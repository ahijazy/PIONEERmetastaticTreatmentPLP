...
OhdsiRTools::checkUsagePackage("PIONEERmetastaticTreatmentPLP")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/PIONEERmetastaticTreatmentPLP.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PIONEERmetastaticTreatmentPLP.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "PIONEERmetastaticTreatmentPLP")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("PIONEERmetastaticTreatmentPLP")
